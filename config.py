...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002304235142"))
...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002112302842"))
...
try:
    ADMINS=[5082638362]
    for x in (os.environ.get("ADMINS", "7350721166 8108281129").split()):
        ADMINS.append(int(x))
except ValueError:
